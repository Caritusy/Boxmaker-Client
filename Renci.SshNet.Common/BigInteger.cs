...
public struct BigInteger : IComparable, IComparable<BigInteger>, IFormattable, IEquatable<BigInteger>
{
	...
	public static BigInteger Random(int bitLength)
	{
		...
		array[array.Length - 1] = (byte)(array[array.Length - 1] & 0x7Fu);
	...
	{
		if (!Parse(value, tryParse: false, style, provider, out var result, out var exc))
		{
			throw exc;
		}
		return result;
	...
	{
		//Discarded unreachable code: IL_001c, IL_004c
		try
		{
	...
	{
		//Discarded unreachable code: IL_001c, IL_0044
		try
		{
